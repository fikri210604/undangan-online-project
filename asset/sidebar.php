...
<div class="d-flex">
  <!-- Sidebar -->
  <nav id="sidebarMenu" class="text-dark fw-semibold p-3"
    ...
    <div class="d-flex align-items-center mb-3" style="gap: 10px;">
      ...
      <h4 class="text-dark fw-semibold m-0" id="sidebarTitle" style="font-family: 'Montserrat', cursive; font-size: 20px;">Admin
        Nikah</h4>
    </div>
    <ul class="nav flex-column mt-3">
      <li class="nav-item">
        <a class="nav-link text-dark fw-semibold mt-3 <?= ($currentPage == 'dashboard') ? 'active bg-primary rounded' : '' ?>"
          href="dashboard.php">
          <i class="bi bi-house"></i> <span class="link-text hover:text-blue-400"> Dashboard</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-semibold mt-3 <?= ($currentPage == 'tamu') ? 'active bg-primary rounded' : '' ?>"
          href="tamu.php">
          <i class="bi bi-person-lines-fill"></i> <span class="link-text hover:text-blue-400"> Data Tamu</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-semibold mt-3 <?= ($currentPage == 'konfirmasi') ? 'active bg-primary rounded' : '' ?> "
          href="konfirmasi.php">
          <i class="bi bi-check2-circle"></i> <span class="link-text"> Konfirmasi</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-semibold mt-3 mb-3 <?= ($currentPage == 'galeri') ? 'active bg-primary rounded' : '' ?> "
          href="galeri.php">
          <i class="bi bi-images"></i> <span class="link-text"> Galeri</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark fw-semibold bg-danger rounded" href="../logout.php">
